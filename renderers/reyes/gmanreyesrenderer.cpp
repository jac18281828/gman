...
void GMANReyesRenderer::render(GMANFrameBuffer* frameBuffer, GMANViewingSystem* viewingSys,
      ...
      while (surf) {
        ...
        while (face) {
          if (viewingSys->visible(face)) {
            ...
            (void)clipper.clip(face, outPoly, viewingSys);
...
void GMANReyesRenderer::reyes(GMANOutputPolygon& /*out*/, GMANFrameBuffer* /*frameBuffer*/) {}

// trace a ray from screen x and screen y
void GMANReyesRenderer::traceRay(RtInt /*xs*/, RtInt /*ys*/, GMANFrameBuffer* /*frameBuffer*/,
