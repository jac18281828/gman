 ...
 * class existed, still links and runs: GMANSurfaceEnv's occluder defaults
 * to null, and diffuse/specular treat null as every light visible, today's
 * behaviour, until that shader is rebuilt against this header.
 */
