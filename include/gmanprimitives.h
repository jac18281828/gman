...
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANPrimDatStorage : public virtual GMANPrimitive {
protected:
...
////  GMAN_BLOBBY.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANBlobby : public GMANPrimDatStorage {
private:
  int* counter;
...
////  GMAN_CONE.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANCone : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtFloat height;
  RtFloat radius;
  RtFloat thetamax;
...
////  GMAN_CURVES.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANCurves : public GMANPrimDatStorage {
private:
...
////  GMAN_CYLINDER.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANCylinder : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtFloat radius;
  RtFloat zmin;
  RtFloat zmax;
...
////  GMAN_DISK.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANDisk : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtFloat height;
  RtFloat radius;
  RtFloat thetamax;
...
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANGeneralPolygon : public GMANPrimDatStorage {
private:
...
////  GMAN_HYPERBOLOID.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANHyperboloid : public GMANPrimDatStorage, public GMANParametric {
protected:
  GMANPoint point1;
  GMANPoint point2;
  RtFloat thetamax;
...
////  GMAN_NUPATCH.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANNuPatch : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtInt nu;
  RtInt uorder;
...
////  GMAN_PARABOLOID.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANParaboloid : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtFloat rmax;
  RtFloat zmin;
  RtFloat zmax;
...
////  GMAN_PATCH.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANPatch : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtToken pt;
  bool bicubic;
  GMANPoint corner[4];
...
////  GMAN_PATCHMESH.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANPatchMesh : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtToken pt;
  RtInt nu;
  bool uPeriodic;
...
////  GMAN_POINTS.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANPoints : public GMANPrimDatStorage {
protected:
  RtInt npoints;
...
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANPointsGeneralPolygons : public GMANPrimDatStorage {
private:
...
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANPointsPolygons : public GMANPrimDatStorage {
private:
...
////  GMAN_POLYGON.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANPolygon : public GMANPrimDatStorage {
protected:
  RtInt nvert;
...
////  GMAN_TORUS.HH
///////////////////////////////////////////////////////////////////////////////////////////////
class GMANTorus : public GMANPrimDatStorage, public GMANParametric {
protected:
  RtFloat majorradius;
  RtFloat minorradius;
  RtFloat phimin;
