...
bool GMANTIFFReader::decode(std::uint32_t &width, std::uint32_t &height,
  ...
  const int ok = TIFFReadRGBAImageOriented(
      handle, width, height, raster.data(), ORIENTATION_TOPLEFT, 0);
...
bool GMANTIFFWriter::available() { return true; }
...
bool GMANTIFFReader::available() { return false; }
...
bool GMANTIFFWriter::available() { return false; }
...
std::size_t GMANTIFFWriter::scanlineSize() const { return 0; }
