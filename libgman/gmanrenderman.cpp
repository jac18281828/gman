...
// The five pixel filters live in gmanfilters.cpp and the five RtBasis
// globals in gmanbasis.cpp. Defining them here too is why linking both
// libraries was always broken.
...
// *********************************************************************
RtVoid GMANRenderMan::push() { steps.push(steps.top()); }
...
// ******* ******* ******* ADDITIONAL OPTIONS ******* ******* *******
// ******************************************************************
RtVoid GMANRenderMan::ColorSamples(RtInt n) { colorNComps = n; }
