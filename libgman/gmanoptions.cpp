...
GMANOptions::GMANOptions() : imagerModule(NULL), imager(NULL) {
  ...
  setCropWindow(DefaultCropWindowXMIN, DefaultCropWindowXMAX, DefaultCropWindowYMIN, DefaultCropWindowYMAX);
...
RtVoid GMANOptions::setFrameAspectRatio(RtFloat ar) { frameAspectRatio = ar; }
...
RtVoid GMANOptions::setScreenWindow(RtFloat left, RtFloat right, RtFloat bottom, RtFloat top) {
...
const GMANOptions::ScreenWindowStruct GMANOptions::getScreenWindow(RtVoid) const {
...
RtVoid GMANOptions::setCropWindow(RtFloat xmin, RtFloat xmax, RtFloat ymin, RtFloat ymax) {
...
RtVoid GMANOptions::setCameraToWorld(GMANMatrix4 const& m) { cameraToWorld = m; }

GMANMatrix4 const& GMANOptions::getCameraToWorld(RtVoid) const { return cameraToWorld; }

// ******* ******* DISPLAY OPTIONS ******* *******
RtVoid GMANOptions::setPixelVariance(RtFloat var) { pixelVariance = var; }
