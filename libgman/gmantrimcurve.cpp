...
GMANTrimCurve::GMANTrimCurve(GMANTrimCurve const& tc) { copy(tc); }
...
GMANTrimCurve::~GMANTrimCurve() { destroy(); }
...
GMANTrimCurve::GMANTrimCurve(RtInt nl, RtInt* nc, RtInt* ord, RtFloat* kn, RtFloat* mn, RtFloat* mx, RtInt* nn,
                             RtFloat* uu, RtFloat* vv, RtFloat* ww) {
  int i;
  int nbcrvs;
  int nbcoords;
  int knotsize;
