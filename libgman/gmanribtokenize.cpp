...
const GMANToken GMANRIBTokenize::getNext(std::istream& ribFile) {
  char c;
...
const GMANToken GMANRIBTokenize::parseKeyword(std::istream& ribFile) {
  char c;
...
const GMANToken GMANRIBTokenize::parseString(std::istream& ribFile) {
  char c;
